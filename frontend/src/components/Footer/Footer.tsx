    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <Link href="/" className="footer__logo">
              <span>🍛</span>
              <div>
                <span className="footer__logo-name">Premacha Vada</span>
                <p className="footer__tagline">Authentic taste, made with love.</p>
              </div>
            </Link>
            <p className="footer__desc">
              Bringing the authentic flavors of Mumbai&apos;s beloved street food to your doorstep. Every bite tells a story of tradition and passion.
            </p>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__contact-list">
              ...
              <li>
                ...
                <span>hello@premachavada.com</span>
              </li>
              <li>
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} Premacha Vada. All rights reserved. Made with ❤️ in Mumbai.</p>
